...
public class ProcessFileRoleConstant {
    ...
    static {
        ...
        // 初始化审批级别到角色代码的映射
        // 审批流程：车间主任审核 → 生产技术部经理批准 → 注塑部经理会签
        APPROVAL_LEVEL_TO_ROLE_CODE_MAP.put(1, ROLE_CODE_WORKSHOP_DIRECTOR); // 车间主任审核
        APPROVAL_LEVEL_TO_ROLE_CODE_MAP.put(2, ROLE_CODE_PRODUCTION_TECH_MANAGER); // 生产技术部经理批准
        APPROVAL_LEVEL_TO_ROLE_CODE_MAP.put(3, ROLE_CODE_INJECTION_MANAGER); // 注塑部经理会签
        
        // 初始化审批级别到角色名称的映射
        APPROVAL_LEVEL_TO_ROLE_NAME_MAP.put(1, ROLE_NAME_WORKSHOP_DIRECTOR);
        APPROVAL_LEVEL_TO_ROLE_NAME_MAP.put(2, ROLE_NAME_PRODUCTION_TECH_MANAGER);
        APPROVAL_LEVEL_TO_ROLE_NAME_MAP.put(3, ROLE_NAME_INJECTION_MANAGER);
    }
